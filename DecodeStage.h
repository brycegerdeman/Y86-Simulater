...
class DecodeStage: public Stage {
   ...
   public:
      ...
      uint64_t fwdsrcA(D * dreg, M * mreg, W * wreg, Stage ** stages, uint64_t srcA, uint64_t valA);
      uint64_t fwdsrcB(D * dreg, M * mreg, W * wreg, Stage ** stages, uint64_t srcB, uint64_t valB);
};
